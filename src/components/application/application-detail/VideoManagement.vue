<template>
  <div>
    ...
    <vue-dropzone
        ...
        class="mb-4"
    ></vue-dropzone>
    <div class="row mb-4" v-if="!$store.state.application.applicationDetail.basvuruKapali&&!isApplicationCancelled&&$store.state.application.videos.dosyalar&&$store.state.application.videos.dosyalar.length>0">
      <div class="col">
