<template>
  <div>
    ...
    ></vue-dropzone>
    <div class="row mb-4"
         v-if="!$store.state.application.applicationDetail.basvuruKapali&&!isApplicationCancelled&&$store.state.application.files.dosyalar&&$store.state.application.files.dosyalar.length>0">
      <div class="col">
