<template>
  <div>
        ...
        <div class="col">
          <div class="form-group">
            ...
            <b-form-select
                ...
                :options="$store.state.hr.documentTypes"
                value-field="id"
                text-field="metin"
                plain
            ...
            <template v-if="$v.form.documentTypeId.$error">
              <small class="text-danger" v-if="!$v.form.documentTypeId.required">{{ this.getMessage(162) }}</small>
            </template>
          </div>
        </div>
        <div class="col-2">
          <div class="form-group">
            ...
            <template v-if="$v.form.ebys.$error">
              <small class="text-danger" v-if="!$v.form.ebys.required">{{ this.getMessage(83) }}</small>
            </template>
          </div>
        </div>
      </div>
          ...
          <div class="col">
            <div class="form-group">
              ...
              <template v-if="$v.form.startDate.$error">
                <small class="text-danger" v-if="!$v.form.startDate.requiredIf">{{ this.getMessage(249) }}</small>
              </template>
            </div>
          </div>
          <div class="col">
          ...
          <div class="col">
            <div class="form-group">
              ...
              <template v-if="$v.form.ebysNo.$error">
                <small class="text-danger" v-if="!$v.form.ebysNo.requiredIf">{{ this.getMessage(84) }}</small>
              </template>
            </div>
          </div>
        </div>
        ...
        <div class="col-10">
          <div class="form-group">
            ...
            <template v-if="$v.form.fileName.$error">
              <small class="text-danger" v-if="!$v.form.fileName.required">{{ this.getMessage(85) }}</small>
            </template>
          </div>
        </div>
        <div class="col-2">
    ...
    <table class="table table-hover">
      ...
      <tbody>
      <tr v-for="(item,index) in $store.state.hr.documents" :key="index">
...
export default {
  ...
  methods: {
    ...
    ...mapActions('hr', ['deleteDocument', 'addDocument', 'getDocumentParameters', 'getDocuments', 'checkEbysDocuments']),
    searchEbys() {
